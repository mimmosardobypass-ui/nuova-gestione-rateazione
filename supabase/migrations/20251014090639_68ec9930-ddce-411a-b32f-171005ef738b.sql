-- Group 'in_ritardo' with 'attiva' and normalize uppercase statuses in v_rateations_stats_v3
-- This makes the "Attiva" filter include both punctual and late-but-active rateations
...
SELECT
  ...
  -- Normalize status: group 'in_ritardo' with 'attiva' and handle uppercase
  CASE
