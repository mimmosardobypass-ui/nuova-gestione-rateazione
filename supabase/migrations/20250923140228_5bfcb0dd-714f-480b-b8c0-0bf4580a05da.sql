-- Aggiungi colonna mancante per lo snapshot del risparmio
ALTER TABLE riam_quater_links 
ADD COLUMN IF NOT EXISTS risparmio_at_link_cents bigint;

-- Drop e ricrea la view per evitare conflitti di colonne
...
SET
  ...
  risparmio_at_link_cents = GREATEST(
