-- Phase 2: Setup Test Data for Migration System (Fixed)
...
-- Get a valid owner_uid from existing rateations
WITH valid_owner AS (
  SELECT owner_uid FROM rateations WHERE owner_uid IS NOT NULL LIMIT 1
)
