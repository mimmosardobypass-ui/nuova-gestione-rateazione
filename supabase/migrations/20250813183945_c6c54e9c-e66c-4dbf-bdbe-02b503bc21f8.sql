...
ALTER VIEW v_installments_status ENABLE ROW LEVEL SECURITY;

-- Create RLS policy for the view
CREATE POLICY "installments_status_owner_view" 
ON v_installments_status 
FOR SELECT 
...
-- Enable RLS on the enhanced summary view
ALTER VIEW v_rateations_summary_enhanced ENABLE ROW LEVEL SECURITY;

-- Create RLS policy for the enhanced summary view
CREATE POLICY "rateations_summary_enhanced_owner_view" 
ON v_rateations_summary_enhanced 
FOR SELECT 
USING (owner_uid = auth.uid());