...
DROP VIEW IF EXISTS v_rateation_summary;
DROP VIEW IF EXISTS v_rateation_installments;
DROP VIEW IF EXISTS v_deadlines_monthly;
...
GROUP BY r.id, r.number, rt.name, r.taxpayer_name, r.total_amount, r.updated_at, r.owner_uid;
