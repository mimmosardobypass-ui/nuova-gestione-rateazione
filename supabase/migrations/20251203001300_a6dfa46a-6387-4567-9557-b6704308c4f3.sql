-- Aggiunge parametro p_include_decayed alla funzione residual_evolution_by_type
-- Per escludere le rateazioni decadute dal calcolo quando richiesto
...
BEGIN
  ...
  base_data AS (
    ...
    WHERE 
      ...
      AND r.status != 'interrotta'
      -- NUOVO: esclude decadute se p_include_decayed = FALSE
